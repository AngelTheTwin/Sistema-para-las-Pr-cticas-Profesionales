 ...
 * @author dagam
 */
public class FXML_InicioDeSesionProfesorController implements Initializable {
        ...
        buttonIniciarSesion.setOnAction(new EventHandler<ActionEvent>(){
            public void handle(ActionEvent event) {
                try {
                    ...
                    Logger.getLogger(FXML_InicioDeSesionProfesorController.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    ...
    @FXML
    public void validarAccesoProfesor() throws SQLException{
        
        try(Connection conectar = conexion.obtenerConexion()){
            String usuario = textFieldUsuario.getText();
            String contraseña = String.valueOf(passwordFieldContraseña.getText());
             
            String consulta  = "Select * from Profesor where NumeroPersonalProfesor=? and ContraseñaProfesor=?";
    ...
    public FXML_InicioDeSesionProfesorController(){
