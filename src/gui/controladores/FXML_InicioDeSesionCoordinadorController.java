 ...
 * @author dagam
 */
public class FXML_InicioDeSesionCoordinadorController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
            buttonIniciarSesion.setOnAction(new EventHandler<ActionEvent>(){
                public void handle(ActionEvent event) {
                    try {
                        validarAccesoCoordinador();
                    } catch (SQLException ex) {
                        Logger.getLogger(FXML_InicioDeSesionCoordinadorController.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            });
    ...
    public void validarAccesoCoordinador() throws SQLException{
        
        try(Connection conectar = conexion.obtenerConexion()){
            String usuario = textFieldUsuario.getText();
            String contraseña = String.valueOf(passwordFieldContraseña.getText());
             
            String consulta  = "Select * from Coordinador where NumeroPersonalCoordinador=? and ContraseñaCoordinador=?";
    ...
    public FXML_InicioDeSesionCoordinadorController(){
